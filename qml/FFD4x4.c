...
vec3 moveVector(vec3 vec)
{
    ...
    result = moveVectorUsingFFDPoint(vec3(0.33, 0.00, 0.0), point01, vec, result);
    result = moveVectorUsingFFDPoint(vec3(0.66, 0.00, 0.0), point02, vec, result);
    result = moveVectorUsingFFDPoint(vec3(1.00, 0.00, 0.0), point03, vec, result);

    result = moveVectorUsingFFDPoint(vec3(0.00, 0.33, 0.0), point10, vec, result);
    result = moveVectorUsingFFDPoint(vec3(0.33, 0.33, 0.0), point11, vec, result);
    result = moveVectorUsingFFDPoint(vec3(0.66, 0.33, 0.0), point12, vec, result);
    result = moveVectorUsingFFDPoint(vec3(1.00, 0.33, 0.0), point13, vec, result);

    result = moveVectorUsingFFDPoint(vec3(0.00, 0.66, 0.0), point20, vec, result);
    result = moveVectorUsingFFDPoint(vec3(0.33, 0.66, 0.0), point21, vec, result);
    result = moveVectorUsingFFDPoint(vec3(0.66, 0.66, 0.0), point22, vec, result);
    result = moveVectorUsingFFDPoint(vec3(1.00, 0.66, 0.0), point23, vec, result);

    result = moveVectorUsingFFDPoint(vec3(0.00, 1.00, 0.0), point30, vec, result);
    result = moveVectorUsingFFDPoint(vec3(0.33, 1.00, 0.0), point31, vec, result);
    result = moveVectorUsingFFDPoint(vec3(0.66, 1.00, 0.0), point32, vec, result);
    result = moveVectorUsingFFDPoint(vec3(1.00, 1.00, 0.0), point33, vec, result);
